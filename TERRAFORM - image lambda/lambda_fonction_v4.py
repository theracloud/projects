#Ver4 : A partir des données reçue par le POST, créer un fichier variables.tf sur S3 avec les bonnes valeurs. Trouver la dernière ami_id amazon linux 2023
import os
import json
import boto3
...
"""
    ...
    return {
        'statusCode': 200,
        'body': json.dumps('First function completed and second function CREATE invoked !')
    }
