...
if ! sudo kubeadm init --pod-network-cidr=10.244.0.0/16 --node-name=controlplane0; then
...
hostnamectl set-hostname controlplane0
...
# après avoir configurer la pub_ssh_key sur controlplane0
